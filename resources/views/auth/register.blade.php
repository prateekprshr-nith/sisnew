    ...
    <div class="container col-sm-offset-2 col-sm-8">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="POST" action="/auth/register" accept-charset="UTF-8" id="registerForm"><input required name="_token" type="hidden">
                    {{ csrf_field() }}
                    ...
                    <!-- Second row Roll no and semester -->
                    <div class="row">
                        <div class="form-group row col-md-6 center-block">
                            <div class="col-md-4 text-right">
                        ...
                        <div class="form-group row col-md-6 center-block">
                            ...
                            <div class="col-md-8">
                                <input required class="form-control" name="semester" type="text" id="semester">
                            </div>
                        </div>
                    </div>

                    <!-- Third row Department and Section-->
                    <div class="row">
                        <div class="form-group row col-md-6 center-block">
                            <div class="col-md-4 text-right">
                    ...
                    <!-- Fourth row DOB no and phone number-->
                    <div class="row">
                        <div class="form-group row col-md-6 center-block">
                            <div class="col-md-4 text-right">
                    ...
                    <div class="row">
                        <div class="form-group row col-md-6 center-block">
                            ...
                            <div class="col-md-8">
                                <textarea required class="form-control" rows="2" name="address" type="text" id="address">
